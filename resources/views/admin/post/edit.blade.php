      ...
      <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('post.update' , $post->id) }}" method="post" enctype="multipart/form-data">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="subtitle" id="sub" placeholder="Enter Post Sub Title" value="{!! $post->subtitle !!}">
                </div>

       
                <div class="form-group">
                  <label for="title">Post Slug</label>
                  <input type="text" class="form-control" name="slug" id="slug" placeholder="Enter Post Slug" value="{!! $post->slug !!}">
                </div>
          ...
          <div class="box-body pad">
            ...
            <textarea id="my-editor" class="form-control" name="body" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ $post->body }}</textarea>
            ...
            CKEDITOR.replace('my-editor', options);
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-primary btn-md">Edit Post</button>
